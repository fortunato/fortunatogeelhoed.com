		...
		<section class="page" #root>
			...
			<div class="container">
				...
				<p class="intro">
					...
					across the frontend, backend, infrastructure and, lately, AI. In the 2010s I was the
						frontend specialist teams reached for when the UI had to be right — depth that
						still anchors today's React, Angular and Vue work; the 2020s broadened it back to
						full-stack and lead. Through every title —
