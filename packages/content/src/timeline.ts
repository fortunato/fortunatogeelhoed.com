...
/** The career timeline dataset — real roles, employers and technologies from
 *  2000 to the present, plus the long-running trading-system side project and
 *  the framework-exposure ribbon.
 *
 *  Year boundaries follow the career reference material; a few are approximate
 *  where sources round to whole years and should be confirmed against the CV. */
	...
	entries: [
		{
			...
			startYear: 2026,
			endYear: 'present',
			organization: 'Self-employed (JiggyBit S.L.)',
			role: 'Portfolio Platform',
			employmentType: 'self-employed',
			summary: 'This site — one backend, three frontends, open-sourced.',
			tech: {
				frontend: ['React', 'Angular', 'Vue'],
				backend: ['Bun', 'Hono'],
				'ci-cd': ['GitHub Actions', 'Docker'],
				'ai-llm': ['Claude Code', 'MCP'],
			},
		},
		{
			id: 'ai-healthcare',
		...
		},
		{
			...
			startYear: 2025,
			endYear: 2026,
			organization: 'Market Breadth',
			role: 'Self-employed',
			employmentType: 'self-employed',
			tech: {
				frontend: ['React', 'Mantine UI', 'Vite', 'Recharts'],
				backend: ['NestJS', 'WebSockets'],
				database: ['TimescaleDB'],
				'ci-cd': ['Gitea Actions', 'Docker'],
				'ai-llm': ['Claude Code', 'OpenClaw', 'MCP'],
			},
		},
		{
			id: 'amsterdam',
			...
			employmentType: 'contractor',
			summary:
				'5.5 years remote: monorepo migration, feature-sliced architecture, micro-frontends.',
			tech: {
				frontend: ['React', 'Redux', 'TypeScript', 'Nx', 'GraphQL', 'Storybook'],
				backend: ['NestJS', 'Express', 'Azure'],
				database: ['PostgreSQL', 'PostGIS'],
				'ci-cd': ['GitLab CI', 'Azure Pipelines', 'GitHub Actions', 'Docker'],
		...
		},
		{
			...
			role: 'Contractor',
			employmentType: 'contractor',
			summary: 'E-commerce SSR rebuild — 3× Lighthouse improvement.',
			tech: {
				frontend: ['React', 'Redux', 'TypeScript/Flow', 'SSR', 'Webpack'],
				backend: ['Node.js', 'Express', 'PHP 5', 'Salesforce'],
				database: ['MySQL'],
		...
		},
		{
			...
			tech: {
				...
				backend: ['Classic ASP', 'PHP 4'],
				database: ['SQL Server'],
				'ci-cd': ['Visual SourceSafe'],
			},
		},
		{
			id: 'web-inzicht',
		...
		},
		{
			...
			startYear: 2018,
			endYear: 'present',
			organization: 'Trading System',
			role: 'Side project',
			employmentType: 'self-employed',
			isSideProject: true,
			summary: 'Runs alongside the day job — evidence of initiative, not a break from work.',
			tech: {
				frontend: ['React', 'Next.js', 'Anychart'],
				backend: ['Node.js'],
				database: ['PostgreSQL'],
				'ci-cd': ['Jenkins', 'Gitea Actions', 'Pulumi', 'k3s'],
				'ai-llm': ['ChatGPT API', 'Claude Code'],
			},
		},
	],
	frameworks: [
